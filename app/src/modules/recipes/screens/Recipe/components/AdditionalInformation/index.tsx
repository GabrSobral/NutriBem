    ...
    <Collapsible title="Informações adicionais">
      <ThemedView style={styles.container}>
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.sodium)).toFixed(2)}g
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.saturated_fat)).toFixed(2)}g
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.polyunsaturated_fat)).toFixed(2)}g
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.monounsaturated_fat)).toFixed(2)}g
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.cholesterol)).toFixed(2)}mg
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.potassium)).toFixed(2)}mg
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.calcium)).toFixed(2)}mg
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.iron)).toFixed(2)}mg
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.fiber)).toFixed(2)}mg
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.sugar)).toFixed(2)}
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.vitamin_a)).toFixed(2)}mcg
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.itemWrapper}>
          ...
          <ThemedText>
            {(quantity * Number(serving?.vitamin_c)).toFixed(2)}mg
          </ThemedText>
        </ThemedView>
      </ThemedView>
    </Collapsible>
