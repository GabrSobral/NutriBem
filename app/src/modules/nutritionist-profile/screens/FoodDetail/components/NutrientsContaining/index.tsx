...
export function NutrientsContaining({ allergen }: Props) {
	...
	const hasMilk = allergen.some(a => a.name === 'Milk' && a.value === '1');
	const hasLactose = allergen.some(a => a.name === 'Lactose' && a.value === '1');
	const hasGluten = allergen.some(a => a.name === 'Gluten' && a.value === '1');
	const hasEgg = allergen.some(a => a.name === 'Egg' && a.value === '1');
	const hasFish = allergen.some(a => a.name === 'Fish' && a.value === '1');
	const hasPeanut = allergen.some(a => a.name === 'Peanuts' && a.value === '1');
	const hasNuts = allergen.some(a => a.name === 'Nuts' && a.value === '1');
	const hasShellfish = allergen.some(a => a.name === 'Shellfish' && a.value === '1');
	const hasSesame = allergen.some(a => a.name === 'Sesame' && a.value === '1');
	const hasSoy = allergen.some(a => a.name === 'Soy' && a.value === '1');
